...
_lr_signature = 'leftPLUSMINUSleftTIMESDIVIDEDIVIDE EQUALS ID LPAREN MINUS NUMBER PLUS RPAREN TIMESstatement : ID EQUALS expressionexpression : expression PLUS expression\n| expression MINUS expression\n| expression TIMES expression\n| expression DIVIDE expressionexpression : LPAREN expression RPARENexpression : NUMBERexpression : ID'
    
_lr_action_items = {'ID':([0,3,6,8,9,10,11,],[2,4,4,4,4,4,4,]),'$end':([1,4,5,7,13,14,15,16,17,],[0,-8,-1,-7,-2,-3,-4,-5,-6,]),'EQUALS':([2,],[3,]),'LPAREN':([3,6,8,9,10,11,],[6,6,6,6,6,6,]),'NUMBER':([3,6,8,9,10,11,],[7,7,7,7,7,7,]),'PLUS':([4,5,7,12,13,14,15,16,17,],[-8,8,-7,8,-2,-3,-4,-5,-6,]),'MINUS':([4,5,7,12,13,14,15,16,17,],[-8,9,-7,9,-2,-3,-4,-5,-6,]),'TIMES':([4,5,7,12,13,14,15,16,17,],[-8,10,-7,10,10,10,-4,-5,-6,]),'DIVIDE':([4,5,7,12,13,14,15,16,17,],[-8,11,-7,11,11,11,-4,-5,-6,]),'RPAREN':([4,7,12,13,14,15,16,17,],[-8,-7,17,-2,-3,-4,-5,-6,]),}
